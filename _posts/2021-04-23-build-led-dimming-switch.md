...
![led-dimmer-demo.webp](/assets/images/led-dimmer-demo.webp)
...
소프트웨어는 우리를 대신해서 어떤 일을 처리해줄 때에 가장 빛납니다. 하드웨어도 마찬가지이죠. 우리를 위한 소프트웨어와 그 밖의 물리적인 일들을 처리해줄 때에 존재 가치가 드러납니다. 이 둘은 우리의 게으름을 응원해 준다는 것 외에도 공통점이 있는데, 만드는 과정이 매우 험난하면서도 나름 재미있습니다(?).
